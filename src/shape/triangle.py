...
class Triangle:
    ...
    def __init__(self, position: Tuple[float, float, float] = (0.0, 0.0, 0.0), size: float = 1.0) -> None:
    ...
    def __get_vertices(self, position: Tuple[float, float, float], size: float) -> List[float]:
